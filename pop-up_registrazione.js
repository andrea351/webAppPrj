document.addEventListener("DOMContentLoaded", function () {
    ...
    // URLSearchParams decodifica automaticamente il link di ritorno
    ...
    document.getElementById("tab-accedi").addEventListener("click", () => mostraTab("accedi"));
    document.getElementById("tab-registrati").addEventListener("click", () => mostraTab("registrati"));
    ...
    function setupTogglePassword(toggleId, inputId, iconId) {
        ...
        toggle.addEventListener("click", function () {
            ...
            // se è una pswd diventa text, e viceversa.
            input.type = isPassword ? "text" : "password";
            // se è pswd mostro l'occhio, se è text mostro occhio sbarrato
    ...
    // asyinc function pk sto usando await
    ...
    document.getElementById("btn-crea-account").addEventListener("click", async function () {
        ...
        // Validazione frontend (forse irrilevante perché tutti i campi sono 'required')
